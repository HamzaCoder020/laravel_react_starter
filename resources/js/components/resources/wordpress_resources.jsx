...
export default function Wordpress_resources() {
    ...
    return  <div className="ui_resource_sec">
        <div className="container">
            <HeadingTag heading="Wordpress Developers You Can Hire" tag="Hire top-notch WordPress developers for exceptional web solutions. Our talented developers deliver outstanding results, ensuring your project is completed on time and to the highest standards."/>
