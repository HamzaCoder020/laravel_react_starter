...
export default function Reactnative_resources() {
    ...
    return  <div className="ui_resource_sec">
        <div className="container">
            <HeadingTag heading="React Native Developers You Can Hire" tag="Hire top-notch React Native developers for exceptional mobile application solutions. Our talented developers deliver outstanding results, ensuring your project is completed on time and to the highest standards."/>
