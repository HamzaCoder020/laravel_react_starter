...
export default function Nodejs_resources() {
    ...
    return  <div className="ui_resource_sec">
        <div className="container">
            <HeadingTag heading="Node.js Developers You Can Hire" tag="With over a decade of experience working with various industries, Atlantis stands out as a prominent company specializing in hiring dedicated Node.js programmers."/>
